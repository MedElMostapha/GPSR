...
<body class="antialiased bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
        ...
        <div class="container mx-auto px-6 py-12 text-center md:text-left">
            <div class="flex flex-col-reverse items-center md:flex-row">
                <div class="w-full md:w-1/2">
                    <h1 class="text-5xl font-bold leading-tight md:text-6xl">Gestions des Publications Scientifiques</h1>
    ...
    <section id="features" class="py-16 bg-white dark:bg-gray-800">
        <div class="container mx-auto px-6">
            ...
            <p class="mt-4 text-center text-lg text-gray-600 dark:text-gray-400">Découvrez les avantages de notre système.</p>
            ...
            <div class="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-gray-700">
                    ...
                    <p class="mt-4 text-gray-600 dark:text-gray-300">Déposez facilement vos publications avec un suivi complet.</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-gray-700">
                    <h3 class="text-xl font-semibold">Calcul automatique des primes</h3>
                    <p class="mt-4 text-gray-600 dark:text-gray-300">Calculez vos primes en fonction des critères définis (Impact Factor, Scopus, Web of Science).</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-gray-700">
                    <h3 class="text-xl font-semibold">Identification IA</h3>
                    <p class="mt-4 text-gray-600 dark:text-gray-300">Identifiez le domaine de la publication et comparez-le aux priorités nationales.</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-gray-700">
                    <h3 class="text-xl font-semibold">Gestion de l’historique</h3>
                    <p class="mt-4 text-gray-600 dark:text-gray-300">Suivez et archivez l’historique de vos publications.</p>
                </div>
                <div class="p-6 bg-gray-50 rounded-lg shadow-lg dark:bg-gray-700">
                    <h3 class="text-xl font-semibold">Base de données avancée</h3>
                    <p class="mt-4 text-gray-600 dark:text-gray-300">Filtrez par auteur, année, ou indexation (Scopus, Web of Science).</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-100 dark:bg-gray-800">
        <div class="container mx-auto px-6">
            ...
            <p class="mt-4 text-center text-lg text-gray-600 dark:text-gray-400">Découvrez les témoignages de nos utilisateurs satisfaits.</p>

            <div class="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-700">
                    <p class="text-gray-600 dark:text-gray-300">"Cette application m’a permis de mieux organiser mes publications scientifiques. Je recommande fortement !"</p>
                    <div class="mt-4 flex items-center">
                        <img src="https://via.placeholder.com/50" alt="Photo utilisateur" class="w-12 h-12 rounded-full">
                        <div class="ml-4">
                ...
                <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-700">
                    <p class="text-gray-600 dark:text-gray-300">"Un outil indispensable pour le suivi et l’archivage de mes recherches."</p>
                    <div class="mt-4 flex items-center">
                        <img src="https://via.placeholder.com/50" alt="Photo utilisateur" class="w-12 h-12 rounded-full">
                        <div class="ml-4">
                ...
                <div class="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-700">
                    <p class="text-gray-600 dark:text-gray-300">"Simple, rapide et efficace. Merci pour cette solution innovante."</p>
                    <div class="mt-4 flex items-center">
                        <img src="https://via.placeholder.com/50" alt="Photo utilisateur" class="w-12 h-12 rounded-full">
                        <div class="ml-4">
